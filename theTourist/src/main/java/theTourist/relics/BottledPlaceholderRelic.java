...
import theTourist.patches.relics.BottledPlaceholderField;
import theTourist.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static theTourist.TouristMod.makeRelicOutlinePath;
import static theTourist.TouristMod.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = TouristMod.makeID("BottledPlaceholderRelic");
